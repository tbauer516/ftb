local args = { ... }
if (#args ~= 1) then
  print("Turtle will go through all the items in it's inventory and will add them to the blacklist provided as an append.")
  print("If no blacklist with the given name exists, it will be created.")
  print()
