...
local butMove4 = button:newStatic("Move 4 Turtles Here")
local butMine = button:newStatic("Send Turtles To Mine")
...
ui:add(butMove4, (size[1] / 2) - (buttonW / 2) + 1, math.floor(size[2] / 4) - math.floor(buttonH1 / 2) + 1, buttonW, buttonH1)
ui:add(butMine, (size[1] / 2) - (buttonW / 2) + 1, math.ceil(3 * (size[2] / 4)) - math.ceil(buttonH1 / 2), buttonW, buttonH1)
ui:run()